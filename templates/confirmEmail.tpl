                              ...
                              <tr>
                                <td align="center"
                                  style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><img
                                    src="https://krjjme.stripocdn.email/content/guids/CABINET_c1b58df9db8b3c20aef32b7192e57bd6/images/illustration_bT0.png"
                                    alt
                              ...
                              <tr>
                                <td align="center" class="es-m-p0r es-m-p0l"
                                  ...
                                  <p
                                    ...
                                    site. Please use this OTP to verify your email address and confirm that you are the
                                    owner of this account.</p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                  <p
                                    ...
                                    &nbsp;© 2021 NotesBucket. All Rights Reserved.</p>
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#333333;font-size:12px">
                                    An open-source note taking application by Shawan Mandal</p>
                                </td>
                              </tr>
                            </table>
                          </td>
